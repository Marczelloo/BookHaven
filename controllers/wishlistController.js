...
exports.updateWishlist = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({
        newQuantity: wishlistItems[existingItemIndex] ? wishlistItems[existingItemIndex].quantity : 0,
        wishlistItems,
        subtotal,
        discount,
        total,
...
exports.moveToCart = async (req, res) => {
  ...
  try {
    const { wishlistItems, subtotal, discount, total } = await WishlistService.moveToCart(req.session, bookIds);
